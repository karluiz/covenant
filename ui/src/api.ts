...
export interface TaskDraft {
  ...
  /// One of: "claude" | "codex" | "copilot" | "pi" | "hermes" | "cursor" | "kimi".
  executor?:   string;
}
...
export async function canonDeleteOrg(org: string): Promise<void> {
  return invoke("canon_delete_org", { org });
}
...
export interface AgentCard {
  ...
  /// The detail pane's tail, secret-masked. PTY lanes: vt100 screen
  /// lines; ACP lane: last chat turns. Null when nothing to show yet.
  excerpt: string | null;
