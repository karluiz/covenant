...
export const SHORTCUTS: ShortcutEntry[] = [
  ...
  { category: "Panels", keys: ["mod", "K"], label: "Search Canon", description: "Inside the Canon cockpit only: search every kind at once and jump to the unit. Elsewhere this key opens the agent panel." },
