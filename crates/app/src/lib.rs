...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            canon_eval::canon_cancel_evals,
            canon_eval::canon_draft_evals,
            canon_eval::canon_write_evals,
            canon_eval::canon_update_eval,
            canon_eval::canon_delete_eval,
            ...
            covenant_gist::note_get_share,
            covenant_gist::note_list_shares,
            covenant_gist::note_publish,
            covenant_gist::note_revoke,
